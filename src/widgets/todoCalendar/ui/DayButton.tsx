...
import { CalendarDayButton as BaseCalendarDayButton } from '@/shared/ui/shadcn'
import { type ComponentProps } from 'react'

type DayButtonProps = ComponentProps<typeof BaseCalendarDayButton>

const DayButton = ({ className, ...props }: DayButtonProps) => {
  return (
